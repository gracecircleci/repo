...
CATALOG_ID = CatalogEnum.MOVIES.value
...
class CatalogTest(unittest.TestCase):
    ...
    def test_catalog_movies_row_title(self):
    ...
    def test_catalog_movies_row_one_title(self):
    ...
    def test_catalog_movies_row_two_title(self):
    ...
    def test_catalog_movies_row_three_title(self):
        ...
        # compare catalog and vue service
        print('test_catalog_movies_row_three_title')
        print('Diffs ==>> catalog_title=%s, vue_item_title=%s' % (catalog_row_title, vue_item_title))
        self.assertEqual(catalog_row_title, vue_item_title,
                         '\n Diffs ==>> catalog_title=%s, vue_item_title=%s' % (catalog_row_title, vue_item_title))

    def test_catalog_movies_row_four_title(self):
    ...
    def test_catalog_movies_row_five_title(self):
    ...
    def test_catalog_movies_row_length(self):
        ...
        print('len(catalog_row_iids)=%d, len(vue_iid_list)=%d' % (len(catalog_row_iids), len(vue_iid_list)))
    ...
    def test_catalog_movies_row_one_length(self):
    ...
    def xtest_catalog_movies_row_two_length(self):
    ...
    def xtest_catalog_movies_row_three_length(self):
    ...
    def xtest_catalog_movies_row_iids_random_drafting(self):
    ...
    def xxtest_catalog_movies_row_iids(self):
        _, catalog_row_iids, _, vue_iid_list = CatalogCommon.home_row_iids()
        self.assertEqual(catalog_row_iids, vue_iid_list, 
           '\n Diffs ==>> catalog_row_iids=%s, vue_iid_list=%s' % (catalog_row_iids, vue_iid_list))

if __name__ == '__main__':
    unittest.main(testRunner=HTMLTestRunner(output='/Users/gracetzay/Vizio/gtest_repo/test_framework/test_output_dir/movies'))
