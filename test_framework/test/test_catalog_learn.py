...
CATALOG_ID = CatalogEnum.LEARN.value
...
class CatalogTest(unittest.TestCase):
    ...
    def test_catalog_learn_row_title(self):
    ...
    def test_catalog_learn_row_one_title(self):
    ...
    def test_catalog_learn_row_two_title(self):
    ...
    def test_catalog_learn_row_three_title(self):
    ...
    def test_catalog_learn_row_four_title(self):
    ...
    def test_catalog_learn_row_five_title(self):
    ...
    def test_catalog_learn_row_length(self):
    ...
    def xtest_catalog_learn_row_one_length(self):
    ...
    def xtest_catalog_learn_row_two_length(self):
    ...
    def xtest_catalog_learn_row_three_length(self):
    ...
    def xtest_catalog_learn_row_iids_random_drafting(self):
    ...
    def xxtest_catalog_learn_row_iids(self):
        _, catalog_row_iids, _, vue_iid_list = CatalogCommon.home_row_iids()
