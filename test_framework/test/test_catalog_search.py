...
CATALOG_ID = CatalogEnum.SEARCH.value
...
class CatalogTest(unittest.TestCase):
    ...
    def xtest_catalog_home_row_one_length(self):
    ...
    def xtest_catalog_home_row_three_length(self):
    ...
    def xtest_catalog_home_row_iids_random_drafting(self):
